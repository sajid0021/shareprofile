...
import { createExperience } from "../../services/experienceApi";

const experienceSchema = z
  .object({
    company: z.string().min(2, "Company name is required").max(150, "Company name is too long"),

    position: z.string().min(2, "Position is required").max(150, "Position is too long"),

    location: z.string().max(150, "Location is too long").optional(),
...
export function ExperienceForm() {
  ...
  return (
    <Card className="p-6">
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-[#1D2226]">Add Experience</h1>

        <p className="mt-1 text-sm text-[#666666]">Add your professional work experience.</p>
      </div>
